...
#vti_list = ["4_rc_0p1.vti", "5_rc_0p1.vti", "6_rc_0p1.vti", "7_rc_0p1.vti", "8_rc_0p1.vti", "4_rc_0p5.vti", "5_rc_0p5.vti", "6_rc_0p5.vti", "7_rc_0p5.vti", "8_rc_0p5.vti"]
vti_list = ["N6_05_01_1_sigma2_HJ.vti"]
...
for vti_file in vti_list :
    ...
    # === Parametres === 
    output_dir = "post/avg_plots"
    dpi = 200  # qualite des images

    # === Chargement du fichier VTI ===
    grid = pv.read(f"vti/{vti_file}")
    ...
    # === Fichier ===
    fichier = "post/avg_plots/curves/velocity_z_azim_avg.npy"
    ...
    correctif_gamma = 11.5#/val_vti[0]
    val_vti_corrige = val_vti * correctif_gamma

    

    print(f"Correctif gamma = {correctif_gamma}")
    ...
    V_r_data = np.load(f"post/avg_plots/curves/velocity_y_azim_avg.npy")
    W_r_data = np.load(f"post/avg_plots/curves/velocity_z_azim_avg.npy")
    ...
    # === Fichier ===
    fichier = "post/TKE_plots/TKE_azim_avg.npy"
